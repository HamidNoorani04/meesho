...
<main class="container">
  ...
  <section class="banner">
    <div class="carousel">
      <div class="carousel-track" id="track">
        <img src="<?php echo asset('assets/banner/bb1.webp'); ?>" alt="Diwali Sale">
        <img src="<?php echo asset('assets/banner/bb2.webp'); ?>" alt="Mega Blockbuster Sale">
        <img src="<?php echo asset('assets/banner/bb3.webp'); ?>" alt="Up to 80% Off">
      </div>
  ...
  <section class="offer-strip">
    <div class="pill-marquee-container">
      <div class="pill-marquee-content">
  ...
  <section class="deals">
    <div class="section-title">
      Daily Deals <span class="zap">⚡</span> <span id="dd-timer">08m:21s</span>
    </div>
  </section>
  ...
  <section class="product-list">
    ...
    <?php if(empty($products)): ?>
      <div style="text-align:center;padding:40px 0;color:#666">
        <p style="font-size:18px;margin-bottom:12px">No products available yet</p>
        <p>Add products from <a href="<?php echo url('admin.php'); ?>" style="color:var(--accent-2)">Admin Panel</a></p>
      </div>
    <?php else: ?>
      <div class="grid">
        <?php foreach($products as $p): ?>
          <a class="prod-card" href="<?php echo url('product.php?id='.urlencode($p['id'])); ?>">
  <div class="thumb" style="background-image:url('<?php echo htmlspecialchars($p['images'][0] ?? ''); ?>')">
    <?php if(!empty($p['badge'])): ?>
      <span class="badge"><?php echo htmlspecialchars($p['badge']); ?></span>
    <?php endif; ?>
  </div>
  <div class="pc-body">
    ...
    <div class="price">
      ...
      <span class="discount"><?php echo round((($p['mrp'] - $p['price']) / $p['mrp']) * 100); ?>% off</span>
    </div>
    <div class="offers-badge">
      ₹<?php echo number_format($p['price'] - 56); ?> with 3 Special Offers
    </div>
    <div class="meta">
      <div style="display:flex;align-items:center;gap:8px">
        <span class="rating-badge">
          <?php echo $p['rating'] ?? '4.2'; ?> ★
        </span>
        <span class="reviews-count">(<?php echo number_format($p['reviews'] ?? 4675); ?>)</span>
      </div>
