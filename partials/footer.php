...
<footer class="site-footer">
  <nav class="tabbar">
    <a href="<?php echo url('index.php'); ?>" class="tab<?php if(($activeTab ?? '')==='home') echo ' active';?>">
      <div><svg width="26" height="27" fill="none" xmlns="http://www.w3.org/2000/svg" iconsize="26" class="sc-gswNZR jGNacQ">
